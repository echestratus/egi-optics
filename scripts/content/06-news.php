...
$egi_photo_1 = 'paspampres-demonstration-brig-gen-laode-laser-gun.jpg';
$egi_photo_2 = 'paspampres-demonstration-lt-col-denny-sopyan-laser-gun.jpg';
$egi_photo_3 = 'paspampres-demonstration-brig-gen-laode-egi-team.jpg';
...
$egi_content = ''
	...
	. egi_content_gallery(
		array(
			array( $egi_photo_1, 'Brig. Gen. TNI Laode test-fires the counter-UAV laser gun, wearing Class IV protective eyewear.' ),
			array( $egi_photo_2, 'Lt. Col. Inf. Denny Sopyan walks the delegation through the operating procedure.' ),
		)
	)
	...
	. egi_content_gallery(
		array(
			array( $egi_photo_3, 'Brig. Gen. TNI Laode in discussion with the EGI Optik Indonesia team after the demonstration.' ),
		)
	)
	...
	. egi_b_list(
		array(
			...
			'<strong>Paspampres delegation:</strong> Brig. Gen. TNI Laode, Lt. Col. Inf. Denny Sopyan and nine officers and NCOs',
...
$egi_post_id = egi_content_upsert_post(
	array(
		...
		'post_excerpt'  => 'The Presidential Security Force evaluated EGI\'s man-portable laser weapon system at its Tanah Abang headquarters on 7 September 2026: live firing led by Brig. Gen. TNI Laode, a walk-through of every operating mode and constructive feedback for the next iteration.',
